...
<head>
	...
	<title>Sayyed Jamal Ghasemi - Online Profile</title>
</head>
...
<body>
	<header>
		<nav>
			<ul>
				<li><a href="https://www.linkedin.com/in/jamal1364/">My linkedin profile</a></li>
				<li><a href="https://instagram.com/jamal13647850">My instagram profile</a></li>
				<li><a href="http://t.me/jamaldev">My telegram chanel</a></li>
			</ul>
		</nav>
	</header>
	<div id="center">
		<div id="center-set"> -written by Sayyed Jamal Ghasemi
			<div id="signup">
				<div id="signup-st">
					<div align="center">
						<?php
					...
					<form name="reg" action="execute.php" onsubmit="return validateForm()" method="post" id="reg">
						<table border="0" align="center" cellpadding="2" cellspacing="0">
							...
							<tr>
								<td class="t-1">
									<div align="left" id="tb-name">Last&nbsp;Name:</div>
								</td>
					...
					<div id="reg-bottom" class="btmrg">Copyright &copy; 2020 Sayyed Jamal Ghasemi</div>
				</div>
			</div>
			<div id="login">
				<div id="login-st">
	...
	<div id="footer">
		<p> Copyright &copy; 2020 Sayyed Jamal Ghasemi </p>
	</div>
</body>
